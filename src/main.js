...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const slides = [
    ...
    {
      title:
        "A car slices through the desert, shadow casing the wind as clouds of dust rise behind, blurring the horizon into gold and thunder.",
      image: "./src/assets/img2.jpg",
    },
    {
      title:
        "Reflections ripple across mirrored faces, each one of fragment of identity, caught between defiance, doubt, and the silence of thought.",
